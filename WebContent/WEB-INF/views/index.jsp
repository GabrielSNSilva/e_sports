      ...
      <div class="row">
        ...
        <div class="col-md-6 col-lg-4">
          <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal2">
            ...
            <img class="img-fluid" src="img/produtos/produto2.jpg" alt="">
            <h2>R$56,00</h2>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal3">
            ...
            <img class="img-fluid" src="img/produtos/produto3.jpg" alt="">
            <h2>R$56,00</h2>
          <p>Easy Polo Black Edition</p>
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal4">
            ...
            <img class="img-fluid" src="img/produtos/produto4.jpg" alt="">
            <h2>R$56,00</h2>
          <p>Easy Polo Black Edition</p>
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal5">
            ...
            <img class="img-fluid" src="img/produtos/produto5.jpg" alt="">
            <h2>R$56,00</h2>
          <p>Easy Polo Black Edition</p>
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal6">
            ...
            <img class="img-fluid" src="img/produtos/produto6.jpg" alt="">
            <h2>R$56,00</h2>
          <p>Easy Polo Black Edition</p>
          </div>
        </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-4">
          ...
          <p class="lead mb-0">Acesso <a href="admin_index">administrador</a>.</p>
        </div>
